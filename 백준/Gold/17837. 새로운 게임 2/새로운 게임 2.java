...
public class Main {
  ...
  static void move(int r, int c, Horse h) {
    ArrayDeque<Horse> horseTower = horseBoard[h.r][h.c];
    ArrayDeque<Horse> newHorseTower = new ArrayDeque<>();
    while (!h.equals(horseTower.peekFirst())) {
      newHorseTower.offer(horseTower.pollFirst());
    }
    horseBoard[h.r][h.c] = newHorseTower;
